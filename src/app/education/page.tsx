            ...
            <div className="bg-[#0a0a0a] p-8 rounded-xl shadow-lg border border-blue-900">
              ...
              <div className="mt-6 space-y-4">
                ...
                <div className="text-gray-300 text-xl">
                  <h4 className="text-2xl font-semibold text-white mb-2">Relevant Coursework:</h4>
                ...
                <div className="text-gray-300 text-xl">
                  <h4 className="text-2xl font-semibold text-white mb-2">Activities:</h4>
                  <ul className="list-disc list-inside space-y-2">
                    <li>Tartan Student Fund</li>
                    <li>CMU Quant Club</li>
                    <li>CMU Tennis Club</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-12">
            ...
            <div className="bg-[#0a0a0a] p-8 rounded-xl shadow-lg border border-blue-900">
              <div className="flex justify-between items-start mb-4">
                ...
                <p className="text-gray-300 text-xl">2019 - 2023</p>
              </div>
              <div className="mt-6 space-y-4">
                <p className="text-gray-200 text-xl">GPA: 4.0/4.0</p>
                <div className="text-gray-300 text-xl">
                  <h4 className="text-2xl font-semibold text-white mb-2">Notable Achievements:</h4>
                  <ul className="list-disc list-inside space-y-2">
